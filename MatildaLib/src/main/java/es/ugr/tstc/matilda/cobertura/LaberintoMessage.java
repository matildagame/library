...
public class LaberintoMessage {
     ...
     * @param mensajeCrudo
     */
    public LaberintoMessage(String mensajeCrudo) {
    ...
    private CharacterDescription parseCharacterDescription(String characterDescriptionString) {
        ...
        String[] desc = characterDescriptionString.split(DEL2);
     ...
     * @param room
     */
    public void buildMJoinRequest(String username, CharacterDescription characterDescription, String room) {
        type = TYPES.mJoinRequest;
    ...
    private String serializeCharacterDescription(String username, String characterMesh, String mainTexture, String hairTexure, String playerID) {
        return username + DEL2 + characterMesh + DEL2 + mainTexture + DEL2 + hairTexure + DEL2 + playerID;
    }
